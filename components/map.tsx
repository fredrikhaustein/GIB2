...
function MultipleMarkers({
        ...
        const sendGetRequestRoutes = async (url) => {
                try {
                        ...
                        if (parsedGPX.trk) {
                                const pos =
                                        parsedGPX.trk[0].trkseg[0].trkpt.map(
                                                (p) => [p.$.lat, p.$.lon]
                                        );
                                routesList = [...routesList, pos];
                        }
                        if (parsedGPX.wpt) {
                                const list = parsedGPX.wpt.map((p) => [
                                        p.$.lat,
                                        p.$.lon,
                                ]);
                                        ...
                                        <Marker
                                                ...
                                                eventHandlers={{
                                                        click: (e) => {
                                                                ...
                                                                setMountainNameRecoil(
                                                                        m.navn
                                                                );
                                                                handleOnClickMountainRoutes(
                                                                        m.ogc_fid,
                                                                        mountainData
                                                                );
                                                        },
            ...
            <Popup>{mountainInfo}</Popup>
                                ...
                                {houselatLng && mountainStateLatlng && (
                                        <Routing
                                                ...
                                                destinationCity={mountainLatlng}
                                        />
                                )}
