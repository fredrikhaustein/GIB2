...
const apiAddresse = axios.create({
        baseURL: "https://ws.geonorge.no/adresser/v1/sok?side=0&adressetekst=Os&treffPerSide=10&asciiKompatibel=true&utkoordsys=4258",
});
        ...
        useEffect(() => {
                const fetchData = async () => {
                        try {
                                ...
                                console.log(
                                        "Dette er inputvalue " + inputValue
                                );
                                // if (adresser) {
                                //   setHouseLatlngState(
                                //     adresser.map((a) =>
